...
if __name__ == '__main__':
    ...
    for i in range(6):
        im2 = read_image(f"{i}.bin")
        im2.save(f"{i} times brightness.png")

    im3 = read_image("1.bin")
    im3.save("test.png")
...
# im2 = read_image("UofTPresidentMericGertler-smaller.bin")
# im3 = read_image("UofTPresidentMericGertler-smaller.bin")
# im3.save("UofTPresidentMericGertler-smaller.png")
